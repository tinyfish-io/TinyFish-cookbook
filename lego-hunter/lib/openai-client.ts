...
// Schema for retailer URLs generated by OpenAI
const retailerUrlsSchema = z.object({
  retailers: z.array(
    z.object({
      name: z.string().describe('Name of the retailer'),
      url: z.string().describe('Direct search URL for the Lego set')
    })
  )
})
...
/**
 * Generate retailer search URLs using OpenAI
 */
...
/**
 * Analyze search results and find the best deal using OpenAI
 */
